  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      if(i==0) {
        ...
        H1 = parseFloat(doc.data().Target_1);
        H2 = parseFloat(doc.data().Target_2);
        H3 = parseFloat(doc.data().Target_3);
      } else if(i==8) { 
        Zone9 = doc.data().EmpZone + "\n("+ doc.data().EmpRH +")";
        I1 = parseFloat(doc.data().Target_1);
        I2 = parseFloat(doc.data().Target_2);
        I3 = parseFloat(doc.data().Target_3);
      } else if(i==9) { 
        Zone10 = doc.data().EmpZone + "\n("+ doc.data().EmpRH +")";
        J1 = parseFloat(doc.data().Target_1);
        J2 = parseFloat(doc.data().Target_2);
        J3 = parseFloat(doc.data().Target_3);
      } else if(i==10) { 
        Zone11 = doc.data().EmpZone + "\n("+ doc.data().EmpRH +")";
        K1 = parseFloat(doc.data().Target_1);
        K2 = parseFloat(doc.data().Target_2);
        K3 = parseFloat(doc.data().Target_3);
      } else if(i==11 && xClickMenu=="A") { 
        Zone12 = doc.data().EmpZone + "\n("+ doc.data().EmpRH +")";
        L1 = parseFloat(doc.data().Target_1);
        L2 = parseFloat(doc.data().Target_2);
        L3 = parseFloat(doc.data().Target_3);
      }
      i++;
...
function drawStacked() {
  var data = google.visualization.arrayToDataTable([
    ...
    [ Zone8, H1, H1+"%", H2, H2+"%", H3, H3+"%"],
    [ Zone9, I1, I1+"%", I2, I2+"%", I3, I3+"%"],
    [ Zone10, J1, J1+"%", J2, J2+"%", J3, J3+"%"],
    [ Zone11, K1, K1+"%", K2, K2+"%", K3, K3+"%"],
    [ Zone12, L1, L1+"%", L2, L2+"%", L3, L3+"%"]
  ]);
  var options = {
